...
Полная техническая документация — **`docs/README.md`** (16 разделов: архитектура, каждый
модуль с цитатами кода, eval, результаты экспериментов).

- **`docs/02-installation.md`** — установка, модели, запуск
- **`CHANGELOG.md`** — история проекта (для защиты)
...
```
См. подробности и список моделей в `docs/02-installation.md`.
